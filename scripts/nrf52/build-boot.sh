...
scripts/hex2c.py bin/targets/nrf52_boot/app/@mcuboot/boot/mynewt/mynewt.elf.hex > reloader/src/boards/p8/bootloader.h
make -C reloader BOARD=p8
...
echo "Reloader (DFU) : reloader/build-p8/reloader-mcuboot.zip"
